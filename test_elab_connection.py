#!/usr/bin/env python3
"""
Minimal test script to debug elab connection
"""
...
def test_basic_connection():
    """Test basic connection to elab server"""
    ...
    try:
        ...
        # Try to create a minimal experiment
        experiments_api = ExperimentsApi(api_client)
        
        # Test with template ID 1 (we know this works)
        test_body = {
            "title": "Structure Test - Understanding elab API",
            "body": "Testing to understand the elab experiment structure and response format",
            "template": 1
        }
        ...
        try:
            ...
            if location_header:
                ...
                # Now try to upload a test file to this experiment
                print(f"\n--- Testing file upload to experiment {experiment_id} ---")
                
                uploads_api = UploadsApi(api_client)
                
                # Create a simple test file
                test_file_content = "This is a test file to understand the upload structure"
                test_filename = "test_structure.txt"
