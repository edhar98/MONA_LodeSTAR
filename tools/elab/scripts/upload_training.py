#!/usr/bin/env python3
"""
ELAB utility script for uploading training results.

This script provides a convenient way to upload training results to ELAB.
"""
...
from elab.cli.elab_cli_simple import cmd_upload_training_results


def main():
    """Upload training results to ELAB."""
    parser = argparse.ArgumentParser(
        description='Upload training results to ELAB',
        prog='upload-training'
    )
    
    parser.add_argument('--label', type=str, default=None,
                       help='Custom label for the training run (default: timestamp)')
    parser.add_argument('--title-prefix', type=str, default='LodeSTAR Training Results',
    ...
    print(f"Uploading training results to ELAB...")
